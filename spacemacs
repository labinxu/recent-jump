...
in `dotspacemacs/user-config'."
  (set-variable 'ycmd-server-command '("python" "/home/labinxu/ycmd/ycmd"))
  ;;(set-variable 'ycmd-global-config "")

  (defun show-file-name()
    "Show the full file name in the minibuffer."
    (interactive)
  ...
  (global-set-key (kbd "s-C-f") 'helm-projectile-find-file)
  (global-set-key (kbd "s-l") 'helm-semantic-or-imenu)
